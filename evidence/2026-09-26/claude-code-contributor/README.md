...
Environment/target: api-engineering-lab (GitHub, branch main)
...
- CLAUDE.md: added; loads AGENTS.md so Claude Code follows the same repository rules as other agents.
