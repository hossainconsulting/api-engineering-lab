...
Practise designing, implementing and testing APIs.
...
- [ ] Define a small API contract and request/response examples.
- [ ] Implement input validation and consistent error responses.
- [ ] Add tests for successful requests and failure cases.
- [ ] Document setup instructions and design tradeoffs.
